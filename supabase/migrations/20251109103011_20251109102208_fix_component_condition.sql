/*
  # Fix Component Creation - Correct Condition Value

  1. Changes
    - Fix condition value from 'Good' to 'working' in component auto-creation
    - Valid values are: 'working', 'tested', 'untested', 'defective'
*/

-- Drop existing trigger
DROP TRIGGER IF EXISTS auto_create_components ON assets;

-- Modify function to handle both INSERT and UPDATE with correct condition
